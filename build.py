...
def main():
    ...
    if windows:
        ...
        if flutter:
            ...
            if osx:
                system2(
                    'strip target/release/bundle/osx/MusicLoverRemote.app/Contents/MacOS/MusicLoverRemote')
                system2(
                    'cp libsciter.dylib target/release/bundle/osx/MusicLoverRemote.app/Contents/MacOS/')
