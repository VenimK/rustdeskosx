...
class PlatformFFI {
  ...
  late MusicLoverRemoteImpl _ffiBind;
  ...
  MusicLoverRemoteImpl get ffiBind => _ffiBind;
  ...
  Future<void> init(String appType) async {
    ...
    try {
      ...
      _ffiBind = MusicLoverRemoteImpl(dylib);
  ...
  void _startListenEvent(MusicLoverRemoteImpl musicloverremoteImpl) {
    final appType =
        _appType == kAppTypeDesktopRemote ? '$_appType,$kWindowId' : _appType;
    var sink = musicloverremoteImpl.startGlobalEventStream(appType: appType);
    sink.listen((message) {
      () async {
        try {
